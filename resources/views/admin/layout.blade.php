...
<body class="black-content"> <!-- white-content para tema blanco o black-content para tema negro  -->
  <div class="wrapper">
    <div class="sidebar" data="blue"> <!-- Aquí va el color del tema  -->
    ...
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="adjustments-line text-center color-change">
          <span class="color-label">CLARO</span>
          <span class="badge light-badge mr-2"></span>
          <span class="badge dark-badge ml-2"></span>
          <span class="color-label">OBSCURO</span>
        </li>
      </ul>
    </div>
  </div>
  ...
  <script src="{{ asset('dashboard/js/black-dashboard.min.js?v=1.0.0') }}"></script>
